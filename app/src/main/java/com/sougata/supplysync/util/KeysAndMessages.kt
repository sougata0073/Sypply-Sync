...
object KeysAndMessages {

    const val USER_NOT_FOUND = "User not found"
    const val USER_FOUND = "User found"
    const val TASK_COMPLETED_SUCCESSFULLY = "Task completed successfully"
    const val TASK_FAILED_TO_COMPLETE = "Task failed to complete"
    const val EMPTY_LIST = "List is empty"
    ...
    const val ITEM_SELECTED_KEY = "Item selected"
